...
def parse_args():
    parser = argparse.ArgumentParser(description='Train DHRNet')
    # general
    ...
    parser.add_argument('--is_train', default=False, type=bool, required=True)
...
def main_worker(rank, world_size, dist_url, final_output_dir, args):
    ...
    if args.is_train and cfg.MODEL.INIT_WEIGHTS:
