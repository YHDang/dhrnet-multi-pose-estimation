...
class RandomAffineTransform(object):
    def __init__(self,input_size, output_size, max_rotation,
        ...
        self.min_scale = min_scale  # 0.75
        self.max_scale = max_scale  # 1.5
    ...
    def __call__(self, image, mask, joints, area, bbox):
        ...
        scale *= aug_scale
        aug_rot = (np.random.random() * 2 - 1) * self.max_rotation  # max_rotation -> 30

        if self.max_translate > 0:  # max_translate -> 40
